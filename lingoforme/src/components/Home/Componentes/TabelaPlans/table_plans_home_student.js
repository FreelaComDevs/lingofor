...
import { Container } from "./styles_table_plans_home_student";
...
class TablePlansHomeStudent extends Component {
  constructor(props) {
    super(props);
...
export default connect(mapStateToProps)(translate('translations')(TablePlansHomeStudent))
