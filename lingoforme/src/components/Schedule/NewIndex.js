      ...
      if (filterPlan.length > 1) {
        return (
          <select required name='studentPlanId' value={this.state.studentPlanId} onChange={this.handleChange}  >
            <option>{this.props.t('SELECT')}</option>
      ...
      <div className="view">
        ...
        <section>
          ...
          <div className="toptitle">
            <img src={ScheduleImg} alt={t('ITEM_SCHEDULE')}/>
            <h1>{t('ITEM_SCHEDULE')}</h1>
          </div>
          <div className="container">
            <Schedule>
                ...
                <div className="selectDays">
                  ...
                  <div id='repeatClass' className="repeatClass" style={{display: showRepeat ? 'block' : 'none' }}>
                    ...
                    <ul>
                      ...
                      <li><span>{t('BTN_REPEAT_UNITIL')}:</span>
                        <div className="lineInputs">
              ...
              <div className="buttons">
                <button className="button-blue" onClick={submitHandle}>{t('BTN_SCHEDULE')}</button>
              </div>
            </Schedule>
          </div>
        </section>
