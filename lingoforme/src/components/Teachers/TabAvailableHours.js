...
class TabAvailableHours extends Component {
    constructor (props) {
        super(props)
                                                    ...
                                                    <select name="start" onChange={(e)=> this.handleChange(e,index)} value={slot.start}  >
                                                        { this.state.hours.map((hour,index) => { 
                                                            return (<option key={index.toString()} value={index}>
                                                                        {moment(hour, 'HH:mm:ss').format('hh:mm A')}
                                                                    </option>)
                                                        })}  
                                                    </select>
                                                </li>                                
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(translate('translations')(TabAvailableHours)))