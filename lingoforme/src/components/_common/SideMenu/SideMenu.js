...
class SideMenu extends Component {
  constructor(props) {
    ...
    try {
      ...
      lang = user.nativeLanguageName
        ? languages[user.nativeLanguageName.toLowerCase()]
        : defaultLanguage;
  ...
  hasNotification() {
    ...
    this.service
      .ApiGetParams("notificationmanager/getByNotificationSentToUserId", params)
      .then((res) => {
        const notifications =
          res.result && res.result.items ? res.result.items : [];
            ...
            <li>
              <Link to="/class-rating">
                <MenuItemLingo
                  ...
                  icon={"rating"}
                  isSelected={
                    this.state.selected === "class-rating" ? true : false
                  }
            ...
            <li>
              <Link to="/customer-service">
                <MenuItemLingo
                  ...
                  isSelected={
                    this.state.selected === "customer-service" ? true : false
                  }
                  clickAction={this.handleClick}
                />
              </Link>
            ...
            <li>
              <Link to="/notifications">
                <MenuItemLingo
                  ...
                  icon={"notifications"}
                  isSelected={
                    this.state.selected === "notifications" ? true : false
                  }
                  clickAction={this.handleClick}
            ...
            <li>
              <Link to="/Calendar">
                <MenuItemLingo
                  name={t("SCHEDULE")}
                  icon={"schedule"}
                  isSelected={this.state.selected === "Calendar" ? true : false}
                  clickAction={this.handleClick}
                />
              </Link>
            </li>
            ...
            <li>
              <Link to="/demo-class">
                <MenuItemLingo
                  ...
                  icon={"demo_classes"}
                  isSelected={
                    this.state.selected === "demo-class" ? true : false
                  }
                  clickAction={this.handleClick}
                />
              </Link>
            ...
            <li>
              <Link to="/teachers">
                <MenuItemLingo
                  name={t("TEACHERS")}
                  icon={"teachers"}
                  isSelected={this.state.selected === "teachers" ? true : false}
                  clickAction={this.handleClick}
                />
              </Link>
            </li>
            ...
            <li>
              <Link to="/manage-student">
                <MenuItemLingo
                  ...
                  icon={"students"}
                  isSelected={
                    this.state.selected === "manage-student" ? true : false
                  }
                  clickAction={this.handleClick}
                />
              </Link>
          ...
          <div>
            ...
            <li>
              <Link to="/coordinators">
                <MenuItemLingo
                  ...
                  icon={"coordinator"}
                  isSelected={
                    this.state.selected === "coordinators" ? true : false
                  }
                  clickAction={this.handleClick}
                />
              </Link>
            ...
            <li>
              <Link to="/b2b">
                <MenuItemLingo
                  name={t("B2B")}
                  icon={"b2b"}
                  isSelected={this.state.selected === "b2b" ? true : false}
                  clickAction={this.handleClick}
                />
              </Link>
            </li>
            ...
            <li>
              <Link to="/plans-and-prices">
                <MenuItemLingo
                  name={t("PLANS_&_PRICING")}
                  icon={"plans"}
                  isSelected={
                    this.state.selected === "plans-and-prices" ? true : false
                  }
                  clickAction={this.handleClick}
                />
              </Link>
            ...
            <li className="dropMenu">
              <Link to="/">
                <MenuItemLingo
                  name={t("SETTINGS")}
                  icon={"settings"}
                  isSelected={this.state.selected === "settings" ? true : false}
                  clickAction={this.handleClick}
                />
              </Link>
              ...
              <ul>
                <li>
                  <Link to="/users">
                    <MenuItemLingo
                      name={t("USERS")}
                      isSelected={
                        this.state.selected === "users" ? true : false
                      }
                      clickAction={this.handleClick}
                    />
                  </Link>
                ...
                <li>
                  <Link to="/languages">
                    <MenuItemLingo
                      name={t("LANGUAGES")}
                      isSelected={
                        this.state.selected === "languages" ? true : false
                      }
                      clickAction={this.handleClick}
                    />
                  </Link>
                ...
                <li>
                  <Link to="/countries">
                    <MenuItemLingo
                      name={t("COUNTRIES")}
                      isSelected={
                        this.state.selected === "countries" ? true : false
                      }
                      clickAction={this.handleClick}
                    />
                  </Link>
                ...
                <li>
                  <Link to="/parameterization">
                    <MenuItemLingo
                      name={t("PARAMETERS")}
                      isSelected={
                        this.state.selected === "parameterization"
                          ? true
                          : false
                      }
                      clickAction={this.handleClick}
                ...
                <li>
                  <Link to="/tickets">
                    <MenuItemLingo
                      name={t("TICKETS")}
                      isSelected={
                        this.state.selected === "tickets" ? true : false
                      }
                      clickAction={this.handleClick}
                    />
                  </Link>
                ...
                <li>
                  <Link to="/rating">
                    <MenuItemLingo
                      name={t("RATING")}
                      isSelected={
                        this.state.selected === "rating" ? true : false
                      }
                      clickAction={this.handleClick}
                    />
                  </Link>
                ...
                <li>
                  <Link to="/economic-group">
                    <MenuItemLingo
                      name={t("ECONOMIC_GROUP")}
                      isSelected={
                        this.state.selected === "economic-group" ? true : false
                      }
                      clickAction={this.handleClick}
                    />
                  </Link>
                ...
                <li>
                  <Link to="/notifications-settings">
                    <MenuItemLingo
                      name={t("NOTIFICATIONS")}
                      isSelected={
                        this.state.selected === "notifications-settings"
                          ? true
                          : false
                      }
                      clickAction={this.handleClick}
        ...
        return (
          <div>
            <li>
              <Link to="/contracts">
                <MenuItemLingo
                  name={t("ITEM_CONTRACTS")}
                  icon={"contracts"}
                  isSelected={
                    this.state.selected === "contracts" ? true : false
                  }
                  clickAction={this.handleClick}
                />
              </Link>
  ...
  render() {
    ...
    return (
      <Sidebar
        ...
        styles={{
          root: { height: "200%" },
          overlay: { backgroundColor: "rgba(255,255,255)" },
          sidebar: {
          ...
          <Nav>
                ...
                <li className="myAccount">
                  <Link to="/manage-account">
                    <MenuItemLingo
                      ...
                      icon={"account"}
                      isSelected={
                        this.state.selected === "manage-account" ||
                        this.state.selected === "first-access"
                          ? true
                          : false
                      }
                      clickAction={this.handleClick}
                ...
                <li>
                  <Link to="/">
                    <MenuItemLingo
                      name={t("HOME")}
                      icon={"home"}
                      isSelected={this.state.selected === "" ? true : false}
                      clickAction={this.handleClick}
                    />
                  </Link>
                </li>
            ...
            <div className="language">
              ...
              <Select
                ...
                className={"select"}
                displayEmpty
                name="lang" // className={classes.selectEmpty}
              >
                <MenuItem value={"en"}>
            ...
            <IconList>
              <div className="box-link-app">
                ...
                <div className="icons-app">
                  <a
                    href="https://play.google.com/store/apps/details?id=me.lingofor.app&pli=1"
                    target={"_blank"}
                  >
                    <img src={PlayStore} style={{ padding: "0px" }} />
                  </a>
                  <a
                    href="https://apps.apple.com/br/app/lingofor-me/id1464904000"
                    target={"_blank"}
                  >
            ...
            <IconList>
              ...
              <div className="icons">
                <a
                  href="https://www.instagram.com/lingoforme/"
                  target={"_blank"}
                >
                ...
                <a
                  href="https://www.linkedin.com/company/lingoforme/"
                  target={"_blank"}
                >
